...
use hyperlane_sealevel_token_collateral::processor::process_instruction as process_collateral_instruction;
...
pub fn process_instruction(
    ...
    if MessageRecipientInstruction::decode(instruction_data).is_ok() {
        return process_collateral_instruction(program_id, accounts, instruction_data);
    }
