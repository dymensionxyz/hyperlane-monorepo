...
TOKEN_PROGRAM_PATHS=("hyperlane-sealevel-token" "hyperlane-sealevel-token-collateral",  "hyperlane-sealevel-token-native",  "hyperlane-sealevel-token-collateral-memo", "hyperlane-sealevel-token-native-memo") # TODO: impl and add hyperlane-sealevel-token-memo
