...
export SOL_ENV_DIR="$BASE_PATH/dymension/tests/solana_native_memo_test/environments"
export SOL_PROG_DIR="$BASE_PATH/rust/sealevel/target/deploy"
export SOL_KEY_PATH="$BASE_PATH/dymension/tests/solana_native_memo_test/key.json"
