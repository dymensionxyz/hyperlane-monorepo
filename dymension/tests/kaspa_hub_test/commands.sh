...
# correct version: 0x prefix, but not supported atm by our library on new deposit parsing https://github.com/dymensionxyz/hyperlane-monorepo/blob/e0e4aeb7e0091c8e0f3f3bee9c172d4344fb4185/dymension/libs/kaspa/lib/relayer/src/lib.rs#L25
